...
Script: Aperture Determination for WASP-78 b
'''
...
signal = aperture[where(aperture==3)[0],6]
background = aperture[where(aperture==4)[0],6]
radius = aperture[where(aperture==3)[0],8]
